...
var picklistSchema = mongoose.Schema({
...
module.exports = connections[dbConfName].model("transactionalData-pickList", picklistSchema, 'transactionalData-pickLists'); // Object - Its modeling - Its collection name
...
var inwardSubListSchema = mongoose.Schema({
    inwardListId: {type: String, index: true}, // MongoId of the picklist collection record
...
module.exports = connections[dbConfName].model("transactionalData-inwardSubList", inwardSubListSchema, 'transactionalData-inwardSubLists'); // Object - Its modeling - Its collection name